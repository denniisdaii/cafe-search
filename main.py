...
Bootstrap5(app)
COFFEE_CHOICES = [i*'☕️' for i in range(1, 6)]
...
class CafeForm(FlaskForm):
    ...
    wifi_rating = SelectField('Wifi Rating', choices=WIFI_CHOICES)
    power_rating = SelectField('Power Rating', choices=POWER_CHOICES)
